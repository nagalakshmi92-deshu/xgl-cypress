...
describe('Verification of XGLT-6676CreateOrderlineforAll4typesofGroup_Billboard', () => {
    ...
    it('XGLT-6676 - Create Order line for All 4typesof Group billboard', () => {
        ...
        cy.fixture('Order.json').then(function (data) {
            ...
            cy.log('Clicked on adcopy group type drop down')
                       ...
                       cy.log('Selected adcopy group type-Billboard from the drop down ')
                       cy.wait(10000)
