...
describe('Verification of XGLT-6676CreateOrderlineforAll4typesofGroup_Standard', () => {
    ...
    it('XGLT-6676 - Create Order line for All 4typesof Group Standard', () => {
        ...
        cy.fixture('Order.json').then(function (data) {
            ...
            cy.log('Clicked on adcopy group type drop down')
                       ...
                       cy.xpath('//div[@class="dropDown"]/child::div[@ng-click="optionSelected(option)" and contains(.,"Standard")]').click() 
                       //Save add all the details in ADCopy Group
                       cy.log('Selected adcopy group type-Standard from the drop down ')
                       cy.wait(10000)
